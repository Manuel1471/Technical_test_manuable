defmodule PruebaTecnicaWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {PruebaTecnicaWeb.Layouts, :root}
  ...
  if Application.compile_env(:prueba_tecnica, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PruebaTecnicaWeb.Telemetry
